...
SecretKeySpecsecretKeySpec = new SecretKeySpec( secretKey, CIPHER_ALGORITHM);
	...
	public static String decrypt( String password, String encryptedData ) throws Exception 
	{
		...
		SecretKeySpecsecretKeySpec=newSecretKeySpec(secretKey,CIPHER_ALGORITHM );
		Cipher cipher = Cipher.getInstance( CIPHER_ALGORITHM );
	...
	public static byte[] generateKey( byte[] seed ) throws Exception
	{
		...
		SecureRandomsecureRandom=SecureRandom.getInstance(RANDOM_GENERATOR_ALGORITHM );
