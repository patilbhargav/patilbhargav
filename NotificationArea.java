...
import org.secure.sms.UserPreferences;
...
public class NotificationArea {
	...
	publicstaticfinalStringINCREMENT="net.swierczynski.autoresponder.INCREMENT_COUNTER";
...
{
				CharSequencedescription=String.format(mCtx.getText(R.string.notification_text).toString(), repliesCounter);
	...
	private PendingIntent getNotificationIntent() {
		Intent notificationIntent = new Intent(mCtx, MainActivity1.class);
